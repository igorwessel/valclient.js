# Decline Request Group

Declines a party request
The ID of the party request. Can be found from the Requests array on the currentDetails.

```js
const declineRequestGroup = await client.group.declineRequestGroup("request_id");
```
